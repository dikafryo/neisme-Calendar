...
window.LOCALES = {
  ko: {
    ...
    // 🆕 v26.925.2 정보 / 자동 업데이트
    'settings.info.heading': 'ℹ 정보',
    'settings.info.versionLabel': '현재 버전',
    'settings.info.checkUpdate': '업데이트 확인',
    'settings.info.openDownload': '다운로드 페이지',
    'settings.info.restartNow': '지금 재시작',
    'update.dev': '개발 모드에서는 업데이트를 확인하지 않습니다.',
    'update.checking': '업데이트 확인 중…',
    'update.latest': '최신 버전입니다.',
    'update.availableFmt': '새 버전 v{v} 이 나왔습니다. 이 판은 직접 내려받아 설치해야 해요.',
    'update.downloadingFmt': '새 버전 v{v} 내려받는 중… {p}%',
    'update.readyFmt': '새 버전 v{v} 준비 완료. 지금 재시작하거나, 다음에 앱을 종료할 때 자동으로 설치됩니다.',
    'update.errorFmt': '업데이트를 확인할 수 없습니다: {err}',
    'toast.updateReadyFmt': '새 버전 v{v} 준비됨 — 설정 > 일반에서 재시작',
  ...
  en: {
    ...
    'settings.info.heading': 'ℹ About',
    'settings.info.versionLabel': 'Current version',
    'settings.info.checkUpdate': 'Check for updates',
    'settings.info.openDownload': 'Download page',
    'settings.info.restartNow': 'Restart now',
    'update.dev': 'Update checks are disabled in development mode.',
    'update.checking': 'Checking for updates…',
    'update.latest': 'You are on the latest version.',
    'update.availableFmt': 'Version v{v} is available. This build has to be downloaded and installed manually.',
    'update.downloadingFmt': 'Downloading v{v}… {p}%',
    'update.readyFmt': 'v{v} is ready. Restart now, or it will be installed the next time you quit.',
    'update.errorFmt': 'Could not check for updates: {err}',
    'toast.updateReadyFmt': 'v{v} is ready — restart from Settings > General',
